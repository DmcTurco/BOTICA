...
<div class="flex-1 flex flex-col gap-3">
    ...
    <form id="productoForm"
          action="{{ isset($producto) ? route('employee.products.update', $producto->code) : route('employee.products.store') }}"
          method="POST"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                            ...
                            <div>
                                ...
                                <div class="w-full px-3 py-2.5 text-sm border border-slate-200 rounded-lg bg-slate-50 flex items-center justify-between">
                                    ...
                                    <a href="{{ route('employee.purchases.create', ['product' => $producto->code]) }}"
