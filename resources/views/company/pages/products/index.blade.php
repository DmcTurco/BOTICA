...
<div class="flex-1 flex flex-col gap-3">
    ...
    <div class="bg-white rounded-xl border border-slate-200 px-4 py-3 shadow-sm shrink-0">
        <form action="{{ route('company.products.index') }}" method="GET">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center justify-end gap-1">
                                <a href="{{ route('company.products.edit', $producto->code) }}"
                    ...
                    <tr>
                        <td colspan="8" class="px-5 py-14 text-center">
                            <div class="flex flex-col items-center gap-2 text-slate-400">
                                ...
                                <a href="{{ route('company.products.create') }}" class="text-emerald-600 text-sm hover:underline">Agregar primer producto</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
$(document).ready(function() {
    ...
    $('.btn-eliminar').on('click', function() {
        ...
        const url = "{{ route('company.products.destroy', ':id') }}";
