...
<div class="flex-1 flex flex-col gap-3 min-h-0">
    ...
    <div class="bg-white rounded-xl border border-slate-200 px-4 py-3 shadow-sm shrink-0">
        <form action="{{ route('company.purchases.index') }}" method="GET">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center justify-end">
                                <a href="{{ route('company.purchases.show', $compra->id) }}"
                    ...
                    <tr>
                        <td colspan="7" class="px-5 py-14 text-center">
                            <div class="flex flex-col items-center gap-2 text-slate-400">
                                ...
                                <a href="{{ route('company.purchases.create') }}" class="text-emerald-600 text-sm hover:underline">Registrar primera compra</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
