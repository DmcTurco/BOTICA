...
<div class="flex-1 flex flex-col gap-3">
    ...
    <div class="bg-white rounded-xl border border-slate-200 px-4 py-3 shadow-sm shrink-0">
        <form action="{{ route('company.clients.index') }}" method="GET">
                    ...
                    <tr>
                        <td colspan="6" class="px-5 py-14 text-center">
                            <div class="flex flex-col items-center gap-2 text-slate-400">
                                ...
                                <a href="{{ route('company.clients.create') }}" class="text-emerald-600 text-sm hover:underline">Registrar primer cliente</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
