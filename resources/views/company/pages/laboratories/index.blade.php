...
<div class="flex-1 flex flex-col gap-3 min-h-0">
    ...
    <div class="flex items-center justify-between shrink-0">
        ...
        <a href="{{ route('company.laboratories.create') }}"
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-5 py-3">
                            <div class="flex items-center justify-end gap-1">
                                <a href="{{ route('company.laboratories.edit', $laboratorio->id) }}"
                    ...
                    <tr>
                        <td colspan="7" class="px-5 py-14 text-center">
                            <div class="flex flex-col items-center gap-2 text-slate-400">
                                ...
                                <a href="{{ route('company.laboratories.create') }}" class="text-emerald-600 text-sm hover:underline">Crear primer laboratorio</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
...
$(document).ready(function() {
    ...
    $('.btn-eliminar').on('click', function() {
        ...
        const url = "{{ route('company.laboratories.destroy', ':id') }}";
