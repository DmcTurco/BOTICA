                    ...
                    <div class="card-header p-0 position-relative mt-n4 mx-0 z-index-2">
                        <div
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-white text-sm opacity-8">Administra las categorías de productos para la farmacia</p>
                            </div>
                            <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-outline">
                                                <input type="text" class="form-control" id="buscar" name="buscar"
                                                    placeholder="Nombre o descripción de categoría" value="{{ request('buscar') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-outline-secondary dropdown-toggle" type="button"
                                        id="exportarMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <div class="icon-shape icon-sm bg-gradient-primary shadow text-center border-radius-sm me-2">
                                                        <i class="fas {{ $categoria->icono ?? 'fa-tag' }} text-white opacity-10"></i>
                                                    </div>
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <td>
                                            <p class="text-xs text-secondary mb-0">{{ Str::limit($categoria->description, 50) }}</p>
                                        </td>
                                        ...
                                        <td class="align-middle text-center">
                                            <span class="badge bg-gradient-{{ $categoria->status ? 'success' : 'secondary' }}">
                                        ...
                                        <td class="align-middle">
                                            <div class="ms-auto text-end">
                                                <a href="{{ route('company.categories.edit', $categoria->id) }}" class="btn btn-link text-dark px-3 mb-0">
                                                    <i class="fas fa-pencil-alt text-dark me-2"></i>Editar
                                                </a>
                                                <button type="button" class="btn btn-link text-danger text-gradient px-3 mb-0 btn-eliminar-categoria"
    ...
    $(document).ready(function() {
        ...
        if ($('#categoriasTable').length) {
            $('#categoriasTable').DataTable({
                ...
                dom: 'frtip' // Oculta la búsqueda default de datatable para usar el filtro personalizado
            });
        }
        ...
        $('.btn-eliminar-categoria').on('click', function() {
            ...
            $('#form-eliminar').attr('action', `{{ route('company.categories.index') }}/${id}`);
